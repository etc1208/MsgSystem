...
<div class="navbar navbar-default" role="navigation">
  <div class="navbar-inner">
    ...
    <a class="navbar-brand" href="#"> <img alt="Charisma Logo" src="resources/images/logo20.png" class="hidden-xs"/>
      <span>任务管理平台</span></a>

    <!-- user dropdown starts -->
    <div class="btn-group pull-right theme-container animated tada">
      <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
        <i class="glyphicon glyphicon-user"></i> <span>${sessionScope.loginUser.username}</span>
        ...
        <div class="nav-canvas">
          ...
          <ul id = "leftMenu" class="nav nav-pills nav-stacked main-menu">
            <li class="active" id = "view">
              <a href="staff/staff"><i class="glyphicon glyphicon-user"></i><span>  用户管理</span></a>
            </li>

            <li>
              <a href="task/task"><i class="glyphicon glyphicon-file"></i><span>  任务管理</span></a>
            </li>

            <li class="accordion">
              <a href="#"><i class="glyphicon glyphicon-picture"></i><span> 区域管理</span></a>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="area/area"><i class="glyphicon glyphicon-unchecked"></i> 地图圈选</a></li>
                <li><a href="area/areaInfo"><i class="glyphicon glyphicon-list"></i> 区域信息</a></li>
              </ul>
            </li>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
      ...
      <div class=" row">
        <div class="col-md-3 col-sm-3 col-xs-6">
          <a data-toggle="tooltip" title="总用户数" class="well top-block" href="#">
            <i class="glyphicon glyphicon-globe blue"></i>

            <div>总用户数</div>
            <span class="notification" id="totalNumber"></span>
          </a>
        </div>

        <div class="col-md-3 col-sm-3 col-xs-6">
          <a data-toggle="tooltip" title="警察" class="well top-block" href="#">
            <i class="glyphicon glyphicon-star green"></i>

            <div>警察</div>
            <span class="notification green" id="policeNumber"></span>
          </a>
        </div>

        <div class="col-md-3 col-sm-3 col-xs-6">
          <a data-toggle="tooltip" title="普通用户" class="well top-block" href="#">
            <i class="glyphicon glyphicon-user yellow"></i>

            <div>普通用户</div>
            <span class="notification yellow" id="ordinaryNumber"></span>
          </a>
        </div>

        <div class="col-md-3 col-sm-3 col-xs-6">
          <a data-toggle="tooltip" title="当前在线" class="well top-block" href="#">
            <i class="glyphicon glyphicon-ok-sign red"></i>

            <div>当前在线</div>
            <span class="notification red" id="onlineNumber"></span>
          </a>
        </div>
      </div>
...
<script src="resources/js/taskSystem.staff.js"></script>
</body>
</html>
